...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format">
		...
		<fo:root>
			...
			<fo:page-sequence master-reference="Rechnung">
				<fo:static-content flow-name="xsl-region-before">
					<fo:block text-align="right" font-size="12pt" font-family="Arial">
						<xsl:value-of select="/rechnung/austeller" />
					</fo:block>
				</fo:static-content>

				<fo:static-content flow-name="xsl-region-after">
					<fo:block text-align="left" font-size="12pt" font-family="Arial">
	...
	<xsl:template match="Gedicht/Autor">
		<fo:block font-size="18pt" font-family="Arial"
			space-after.optimum="15pt" background-color="silver" color="white"
			text-align="left">
			<xsl:value-of select="." />
		</fo:block>
	</xsl:template>
	...
	<xsl:template match="Gedicht/Titel">
		<fo:block font-size="16pt" font-family="Arial"
			space-after.optimum="10pt" text-align="start">
			<xsl:value-of select="." />
		</fo:block>
	</xsl:template>
	...
	<xsl:template match="Gedicht/Vers">
		<fo:block font-size="12pt" font-family="Arial"
			space-before.optimum="10pt" space-after.optimum="10pt" text-align="start">
